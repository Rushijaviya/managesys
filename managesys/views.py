...
def login(request):
    con=psycopg2.connect(host="localhost",user="managesys",password="managesys",database="socman")
    cursor=con.cursor()
    con2=psycopg2.connect(host="localhost",user="managesys",password="managesys",database="socman")
    cursor2=con2.cursor()
    con3=psycopg2.connect(host="localhost",user="managesys",password="managesys",database="socman")
    cursor3=con3.cursor()
    con4=psycopg2.connect(host="localhost",user="managesys",password="managesys",database="socman")
    cursor4=con4.cursor()
